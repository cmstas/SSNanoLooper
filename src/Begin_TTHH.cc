...
void Begin_TTHH()
{
    ...
    RooUtil::Histograms hists_TTHH;
    hists_TTHH.addHistogram("h_TTHH_intVar1", 10, 0, 10, [&]() { return ana.tx.getBranch<int>("TTHH_intVar1"); } );
    hists_TTHH.addHistogram("h_TTHH_floatVar1", 180, 0, 500, [&]() { return ana.tx.getBranch<float>("TTHH_floatVar1"); } );
    hists_TTHH.addHistogram("h_TTHH_LVVar1_Pt", 180, 0, 150, [&]() { return ana.tx.getBranch<LorentzVector>("TTHH_LVVar1").pt(); } );
    ...
    ana.cutflow.bookHistogramsForCut(hists_TTHH, "Cut_TTHH_Preselection");
}
