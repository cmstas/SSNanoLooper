...
void Process_TTHH()
{
    ...
    // This is where one sets the variables used for the category TTHH.
    //==============================================
    ...
    ana.tx.setBranch<int>("TTHH_intVar1", -999);
    ana.tx.setBranch<float>("TTHH_floatVar1", -999);
    ...
    LorentzVector LV_TTHH_LVVar1 = RooUtil::Calc::getLV(34.5, 1.2, 3.123, 0.105); // RooUtil::Calc::getLV() creates 4 vector

    ana.tx.setBranch<LorentzVector>("TTHH_LVVar1", LV_TTHH_LVVar1);
}
