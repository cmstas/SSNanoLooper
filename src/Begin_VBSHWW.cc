...
void Begin_VBSHWW()
{
    ...
    RooUtil::Histograms hists_VBSHWW;
    hists_VBSHWW.addHistogram("h_VBSHWW_intVar1", 10, 0, 10, [&]() { return ana.tx.getBranch<int>("VBSHWW_intVar1"); } );
    hists_VBSHWW.addHistogram("h_VBSHWW_floatVar1", 180, 0, 500, [&]() { return ana.tx.getBranch<float>("VBSHWW_floatVar1"); } );
    hists_VBSHWW.addHistogram("h_VBSHWW_LVVar1_Pt", 180, 0, 150, [&]() { return ana.tx.getBranch<LorentzVector>("VBSHWW_LVVar1").pt(); } );
